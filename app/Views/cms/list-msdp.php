...
<div class="card">
    <div class="card-body">
        <div class="d-flex align-items-center justify-content-between  pb-3  ">
            <div class="col-5 p-0">
            <a href="<?= base_url(); ?>msdp" type="button" class=" btn btn-sm btn-primary shadow-sm mr-1 " style="font-size:12px;">Add MSDP </a>
            </div>
                ...
                <tbody class="list-wrapper">
                    ...
                    <?php foreach ($list->getResultArray() as $row) : ?>
                        <tr class="list-item" onclick="location.href='<?= base_url(); ?>print_msdp/<?= $row['id']; ?>'">
                            ...
                            <td style="width:100px;" class="d-sm-table-cell d-none">
                                <?= $row['created_at']; ?>
                            </td>
                            <td>
                                <?= $row['name']; ?>
