                                ...
                                <form action="<?= base_url(); ?>search_leads" method="post" class=" d-lg-block d-none form-inline ">
                                    <div class="input-group input-group-sm mt-2 mr-3 ">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-light border-right border-top border-bottom rounded-right" type="submit">
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <nav class="sidebar sidebar-offcanvas" id="sidebar">
                        <ul class="nav">
                            ...
                            <li class="d-lg-block d-none nav-item <?php if ($title == 'Leads' || $title == 'New' || $title == 'Close'|| $title == 'Pending'|| $title == 'Contacted'|| $title == 'Visit'|| $title == 'Deal'|| $title == 'Search Result') {
                                                                        echo "active";
                                                                    } ?>">
