...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <div class=" d-flex flex-row align-items-center justify-content-between">
            <div>
                <h6 class="mb-4 font-weight-bold text-primary">Report Sales</h6>
            </div>
                    ...
                    <table id="report_new_leads" name="report_new_leads" class="table table-hover" width="100%" style="font-size:12px;">
                        ...
                        <tbody class="list-wrapper">
                            ...
                            ?>
                                ...
                                <!-- list-item -->
                                <tr class="" <?php if ($level == "admin" || $level == "admin_group" || $level == "admin_project" || $level == "manager" || $level == "general_manager") : ?> onclick="location.href='<?= base_url(); ?>user/<?php echo $row['id_user']; ?>'" <?php endif; ?>>
                                    <td><?= $no++; ?></td>
                                    <td>
