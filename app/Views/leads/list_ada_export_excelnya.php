    ...
    <div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="<?= base_url() ?>leads/all" type="button" class=" col px-0 btn  <?= ($title == "Leads") ? 'btn-primary' : 'btn-light bg-white'; ?> rounded mr-1 small"> All </a>
            </div>
            <div class="swiper-slide">
            ...
            <div class="swiper-slide">
                <a href="<?= base_url() ?>leads/contacted" type="button" class="col px-0 btn <?= ($title == "Contacted") ? 'btn-primary' : 'btn-light bg-white'; ?>  rounded mr-1 small"> Contacted </a>
            </div>
            <div class="swiper-slide">
                <a href="<?= base_url() ?>leads/visit" type="button" class="col px-0 btn <?= ($title == "Visit") ? 'btn-primary' : 'btn-light bg-white'; ?> rounded mr-1 small"> Visit </a>
            </div>
            <div class="swiper-slide">
                <a href="<?= base_url() ?>leads/deal" type="button" class="col px-0 btn <?= ($title == "Deal") ? 'btn-primary' : 'btn-light bg-white'; ?> rounded mr-1 small"> Deal </a>
            </div>
        </div>
...
<div class="card">
    <div class="card-body">
        ...
        <div class=" d-flex align-items-center justify-content-between pb-3 ">
            ...
            <div class="d-flex p-0">
                <div class="d-lg-flex d-none">
                    <a href="<?= base_url() ?>leads/all" type="button" class="col btn  <?= ($title == "Leads") ? 'btn-primary' : 'btn-light'; ?> rounded mr-1"> All </a>
                    ...
                    <div class="dropdown flex-md-grow-1 flex-xl-grow-0  mr-1">
                        <button class="btn rounded bg-primary px-3" type="button" id="dropdownMenuDate2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            <i class="ti-export text-white"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                            <a class="dropdown-item" href="#" onclick="exportToExcel()">Export Excel</a>
                            <a class="dropdown-item" href="#" onclick="exportToPDF()">Export PDF</a>
                        </div>
                    </div>

                    <a href="#" type="button" class="btn  rounded bg-primary d-flex justify-content-center align-items-center px-3" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="ti-filter text-white"></i> </a>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive" id="export-div"><!-- table-responsive -->
...
<script>
    $(document).ready(function() {
        ...
        var table = $("#table").DataTable({
            ...
            language: {
                paginate: {
                    previous: "<", // Set the text for previous button
                    next: ">" // Set the text for next button
                }
            }
        });
        ...
        var pagination = $("#table_paginate");
        pagination.detach().appendTo("#paginate");
    });
</script>
...
<script type="text/javascript">
    function exportToExcel() {
        /* Get table data from the div */
        var table = document.getElementById("export-div");
...
<script type="text/javascript">
    function exportToPDF() {
        ...
        var content = document.getElementById("export-div");

        /* Use fromHTML function with proper options */
        pdf.fromHTML(content, 15, 15, {
            width: 180 // Adjust the width if necessary
        });
